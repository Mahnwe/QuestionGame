...
public class StatsVbox extends VBox {
    ...
    public StatsVbox(String statsDescriptionLabel, String statsScoreLabel)
    {
        ...
        statDescriptionLabel.setFont(Font.font(MenuScene.POLICE_LABEL, FontWeight.BOLD, 25));

        statScoreLabel = new Label(statsScoreLabel);
        statScoreLabel.setFont(Font.font(MenuScene.POLICE_LABEL, FontWeight.BOLD, 27));
